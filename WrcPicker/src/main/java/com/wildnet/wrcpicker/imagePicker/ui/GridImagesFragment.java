...
public class GridImagesFragment extends Fragment implements OnImagesLoadListener, WrcImagePicker.OnImageSelectedChangeListener, WrcImagePicker.OnImageCropCompleteListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (wrcImagePicker.cameraMode) {
            try {
                wrcImagePicker.takePicture(GridImagesFragment.this, WrcImagePicker.REQ_CAMERA);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public void onImageSelectChange(int position, ImageItemBean item, int selectedItemsCount, int maxSelectLimit) {
        mAdapter.refreshData(WrcImagePicker.getInstance().getImageItemsOfCurrentImageSet());
    ...
    private boolean shouldSelectMulti() {
        return wrcImagePicker.getSelectMode() == WrcImagePicker.Select_Mode.MODE_MULTI;
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == WrcImagePicker.REQ_CAMERA && resultCode == Activity.RESULT_OK) {
            if (!TextUtils.isEmpty(wrcImagePicker.getCurrentPhotoPath())) {
                WrcImagePicker.galleryAddPic(mContext, wrcImagePicker.getCurrentPhotoPath());
                getActivity().finish();
                ...
                if (wrcImagePicker.cropMode) {
                    ...
                    intent.putExtra(WrcImagePicker.KEY_PIC_PATH, wrcImagePicker.getCurrentPhotoPath());
                    startActivityForResult(intent, WrcImagePicker.REQ_CAMERA);
                } else {
